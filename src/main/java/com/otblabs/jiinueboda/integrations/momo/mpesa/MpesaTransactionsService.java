...
public class MpesaTransactionsService {
    ...
    public StkPushRequestResponse initiateStkpush(StkPushRequest stkRequest, int appId) throws Exception {
        ...
        jsonObject.put("PhoneNumber", UtilityFunctions.formatPhoneNumber(stkRequest.getPhoneNumber()));
        jsonObject.put("PartyA", UtilityFunctions.formatPhoneNumber(stkRequest.getPhoneNumber()));
    ...
    public B2CRequestResponse initiateb2c(B2CRequest b2CRequest, int appId) throws Exception {
        ...
        jsonObject.put("PartyB", UtilityFunctions.formatPhoneNumber(b2CRequest.getPartyB()));
...
//        }
    ...
    public Acknowledgement savePaybillsResponse(String paybillResponse, int appId) throws Exception {
        ...
        try{
            ...
            smsService.sendMessageToSignatories(appId, value,receiverPartyPublicName, String.valueOf(initiatorAccountCurrentBalance.getAmount().getBasicAmount()),signatories);
        }catch (Exception exception){
            exception.printStackTrace();
        }
